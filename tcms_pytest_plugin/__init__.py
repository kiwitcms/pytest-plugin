...
class KiwiTCMSPlugin:
    ...
    def pytest_runtest_logstart(self, nodeid, location):
        ...
        self.executions = self.backend.add_test_case_to_run(test_case['id'], self.backend.run_id)
    ...
    def pytest_runtest_logfinish(self, nodeid, location):
        for execution in self.executions:
            self.backend.update_test_execution(execution["id"], self.status_id, self.comment)
